...
public class AnimatView6 extends ImageView implements SensorEventListener {
...
//    private static int xOffset = 0;
    ...
    public AnimatView6(Context context) {
        super(context);
        init();
    }

    public AnimatView6(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
...
//                Log.d("ZZZ", "drawLeft > currenetLeft: " + (drawLeft>currentLeft?1:0));
                if (direction == INC){
                    TranslateAnimation ta = new TranslateAnimation(drawLeft, currentLeft, 0, 0);
                    ta.setDuration(20);
                    startAnimation(ta);
                }else if (direction == DEC){
                    TranslateAnimation ta = new TranslateAnimation(currentLeft, drawLeft, 0, 0);
                    ta.setDuration(20);
                    startAnimation(ta);
                    direction = 0;
                }
